...
{
	public class NASite : SplObject, IUniquelyIdentifiable
	{
		/// <summary>
		/// AA sequence
		/// </summary>
		public NASubunit Subunit { get; set; }
		...
		/// </summary>
		public NAFragment.ComponentConnector ComponentConnectorRef { get; set; }
        public NAFragment.Connector ConnectorRef { get; set; }

        //end YB: position on proximal moiety


        public NASite(SplObject rootObject, string type)
