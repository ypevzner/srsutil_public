                                      ...
                                      OAD_StructureEdits *ed)
{
    ...
    orig = inchi_calloc(nat + 1, sizeof(int));
    if (!orig)
    {
        ret = _IS_ERROR;
        goto exit_function;
    ...
    */
    all_bkb_orig	= inchi_calloc(2*(orig_at_data->num_inp_bonds + 1), sizeof(int));
    if (!all_bkb_orig)
    {
        ret = _IS_ERROR;
        goto exit_function;
                        ...
                        OAD_StructureEdits *ed)
{
    ...
    frag_xc_counts = inchi_calloc(nxclasses + 1, sizeof(int));
    if (!frag_xc_counts)
    {
        ret = _IS_ERROR;
        goto exit_function;
    ...
    cut = inchi_calloc(2*n_all_bkb, sizeof(int));
    if (!cut)
    {
        ret = _IS_ERROR;
        goto exit_function;
                                         ...
                                         OAD_StructureEdits *ed)
{
    ...
    frame_shift_info = inchi_calloc(3 * (nu + 1), sizeof(int));
    if (!frame_shift_info)
    {
        ret = _IS_ERROR;
        goto exit_function;
